      ...
      <div className="container relative z-10 py-16 md:py-24 lg:py-32">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="hidden lg:block relative h-[500px] w-full">
            ...
            <img 
              src="/lovable-uploads/ac31b027-1064-4dce-a25c-1fc14f39dff1.png" 
              alt="Zn-68 Metal Isotopic Product" 
              className="absolute bottom-0 right-0 w-96 h-96 rounded-xl object-contain shadow-lg animate-fade-in"
              style={{
                animationDelay: '0.6s'
              }}
            />
