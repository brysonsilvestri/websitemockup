        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="max-w-2xl">
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
              <span className="heading-gradient">Premium Chemical</span>
              <br />
              <span className="text-gray-900">Solutions for Industry</span>
            </h1>
          ...
          <div className="hidden lg:block relative h-[500px] w-full">
            <div className="absolute top-10 left-10 w-64 h-64 rounded-xl bg-gradient-to-br from-chembrand-500/20 to-chembrand-100/20 animate-fade-in" style={{ animationDelay: '0.2s' }} />
            <div className="absolute top-20 left-20 w-72 h-72 rounded-full bg-gradient-to-tl from-chembrand-200/30 to-transparent animate-fade-in" style={{ animationDelay: '0.4s' }} />
            <div className="absolute bottom-0 right-0 w-96 h-96 rounded-xl border border-chembrand-100 bg-gradient-to-br from-white to-chembrand-50/50 shadow-lg animate-fade-in" style={{ animationDelay: '0.6s' }}>
